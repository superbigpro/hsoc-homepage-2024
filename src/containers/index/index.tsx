    ...
    <main style={{ width: '100%' }}>
      <Section>
        <S.SectionContentContainer>
          <div>
            <HighlightText>Hello, HSOC</HighlightText>
            <S.Title>
              <small>한세사이버보안고등학교</small>
              <br />
              보안관제 동아리반 모집
            </S.Title>
      ...
      >
        <S.TeacherSectionImage
          src=""
          images={[Contest1PNG.src, Contest2JPG.src, Contest3JPG.src]}
        />
      </SectionTemplate>
      <SectionTemplate
        isSecondary
        ...
        links={[
          { text: '관련 뉴스 기사', href: 'https://www.boannews.com/media/view.asp?idx=102431' },
        ]}
      >
      ...
      >
        <S.ServerRoomSectionImage
          src=""
          images={[ServerRoom1JPG.src, ServerRoom2JPG.src, ServerRoom3JPG.src, ServerRoom4JPG.src]}
        />
      </SectionTemplate>
    </main>
  );
