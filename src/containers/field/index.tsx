    ...
    return (
        <main style={{ width: "100%" }}>
            ...
            <SectionTemplate
                ...
                description={
                    <>
                        암호학은 수학적 원리를 사용하여 중요한 정보를 보호해요. 프로그래밍 언어를 사용하여 암호화 스크립트 및 공격 코드를 작성해요. 
                        Python은 많은 모듈과 라이브러리를 지원하므로 암호화 작업에 많이 사용돼요. Pycryptodome 라이브러리를 사용하면 암호화 작업을 수행할 수 있으며, 
                        gmpy2와 pow()와 같은 수학 모듈과 내장된 모듈식 지수 연산자를 사용할 수도 있어요. SageMath는 Python 기반으로 작성된 도구로 최신 암호화 기술을 지원해요.
                    </>
                }
            >
